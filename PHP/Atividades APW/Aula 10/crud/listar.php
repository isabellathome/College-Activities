    ...
    foreach ($array as $array) {
        ...
        ?>
           <form action="excluir.php" method="get">
				 ...
				 <button><img src='excluir.png' width=30px height=30px></button></td>
			</form> 		  
        <?php	
		echo "</td> ";
		echo  "<td> "; 
		 ?>
           <form action="alterar.php" method="get">
				 ...
				 <button><img src='alterar.png' width=30px height=30px></button></td>
		   </form> 		  
        <?php	
		 echo "</td> ";
		echo "</tr>";		      
...
?>
<div>
<a href="index.php"><img src='cadastrar.jpg' width=40px height=40px></a><br>
</body>
